...
const ministryItemSchema = z.object({
  id: z.string().default(''),
  title: z.string().default(''),
  tag: z.string().default('Proclaim Jesus'),
...
export const siteContentSchema = z.object({
  settings: z.object({
    ...
    siteInfo: z.object({
      churchName: z.string().default(''),
      mobileNumberDisplay: z.string().default(''),
      mobileNumberHref: z.string().default(''),
      contactEmail: z.string().default(''),
      safeguardingEmail: z.string().default(''),
      addressLine1: z.string().default(''),
      addressLine2: z.string().default(''),
      addressShort: z.string().default(''),
      sundayServiceTime: z.string().default(''),
      communionNote: z.string().default(''),
      giving: z.object({
        onlineGivingLabel: z.string().default(''),
        onlineGivingUrl: z.string().default(''),
        standingOrderTitle: z.string().default(''),
        bankTransferTitle: z.string().default(''),
        ...
        referenceNote: z.string().default(''),
        qrCodeImage: mediaAssetRefSchema,
        qrCodeNote: z.string().default(''),
      }),
      parking: z.object({
        parkingNote: z.string().default(''),
        bellStreetCarParkName: z.string().default(''),
        bellStreetCarParkMapUrl: z.string().default(''),
        parkingChargesUrl: z.string().default(''),
      }),
      social: z.object({
